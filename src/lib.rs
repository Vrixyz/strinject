...
fn simple_injection() {
    ...
    let result = inject("<load path='test/to_inject1.txt' marker='ToInject1_1' />");
...
fn marker_short() {
    ...
    let result = inject("<load path='test/to_inject1.txt' marker='ToInject' />");
...
fn nest_removal() {
    ...
    let result = inject("<load path='test/to_inject1.txt' marker='ToInject1_nest' />");
...
fn indent_removal() {
    ...
    let result = inject("<load path='test/to_inject1.txt' marker='ToInject1_indent' />");
...
fn simple_marker_error() {
    ...
    let result = inject("<load path='test/to_inject1.txt' marker='ToInject1_wrong' />");
